...
//     <>
//       <Navbar/>
//       <div className="main flex items-center justify-between" style={{height:}}></div>
//     </>
//   )
// }
...
const App = () => {
  ...
  const ai = new GoogleGenAI({ apiKey: "AIzaSyAptrjQfZb6w8iLc5lkleZEgf2RpV0diYA" }); // replace "YOUR_API_KEY" with you api key
